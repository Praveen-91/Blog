    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="registerForm" action="{{route('postregister')}}">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="nameInput" type="text" class="form-control" name="firstname" value="{{ old('name') }}"  autocomplete="name" autofocus>
                    ...
                    <div class="form-group row">
                        <label for="nameInput" class="col-md-4 col-form-label text-md-right">Last Name</label>

                        <div class="col-md-6">
                            <input id="lastname" type="text" class="form-control" name="lastname" value="{{ old('name') }}"  autocomplete="name" autofocus>
...
<!--                     <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="dob" type="text" class="form-control" name="dob" value=""  autofocus>
                    ...
                    <input  type="hidden" class="form-control" name="role" value=""  autofocus>
